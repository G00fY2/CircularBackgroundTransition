...
class CircularBackgroundTransition constructor(context: Context, attrs: AttributeSet? = null,
  ...
  fun startTransition(nextBackgroundColor: Int) {
    ...
    val fillingRadius = Math.sqrt((layoutWidth * layoutWidth + layoutHeight * layoutHeight).toDouble()).toFloat() / 2
  ...
  companion object {
    private val LAYOUT_CORNER_RADIUS = 0
    private val LAYOUT_MASK_MARGIN = false
